...
namespace Forum.Service.Repositories.Interface;
...
{
    IRepository<ForumCategory> Categories { get; }
    IRepository<ForumPost> Posts { get; }
    IRepository<ForumReaction> Reactions { get; }
    IRepository<ThreadSubscription> Subscriptions { get; }
    IRepository<PostReport> Reports { get; }
