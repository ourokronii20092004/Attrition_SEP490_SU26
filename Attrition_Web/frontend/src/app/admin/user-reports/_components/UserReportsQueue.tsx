...
/**
 * The reported-users queue. Extracted from the page so the merged Reports workspace can render it
 * beside the post-reports queue under one set of tabs; the page title now lives in the workspace.
 */
  ...
  return (
    <div>
      ...
      <AdminTable
        ...
        emptyLabel={status === "Pending" ? "Nothing to moderate." : `No ${status.toLowerCase()} reports.`}
        emptyHint={status === "Pending" ? "Reported users will appear here." : "Try a different status or search."}
      >
        {filtered.map((r) => (
