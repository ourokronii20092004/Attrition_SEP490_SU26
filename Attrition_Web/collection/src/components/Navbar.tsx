      ...
      <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '100%' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-lg)' }}>
          ...
          <div className="nav-links" style={{ display: 'flex', gap: 'var(--space-md)' }}>
            ...
            <a href="https://soundhall.hault.io.vn" target="_blank" rel="noopener noreferrer" className="nav-link" style={{ color: 'var(--gold)' }}>Soundhall</a>
            {user?.role === 'Admin' && <Link href="/admin" className="nav-link" style={{ color: 'var(--soul)' }}>Admin</Link>}
          </div>
        </div>
