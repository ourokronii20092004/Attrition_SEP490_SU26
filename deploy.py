...
# Chỉ upload thư mục Web/Backend lên Server, KHÔNG upload Attrition_Game (vì nó rất nặng và không cần thiết)
PROJECT_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "Attrition_Web")
...
EXCLUDE = {
    ...
    "brain", ".gemini", "client_secret*", ".vs", ".vscode",
}
# ────────────────────────────────────────────────────────
